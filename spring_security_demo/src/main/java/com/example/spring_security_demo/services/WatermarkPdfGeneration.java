...
public class WatermarkPdfGeneration {
    ...
    public InputStreamResource addWaterMarkToPdf(InputStream inputStream, Image image, float width, float height, float opacity) throws IOException, DocumentException {
